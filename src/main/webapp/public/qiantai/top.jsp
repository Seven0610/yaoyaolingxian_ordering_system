...
<li ><a href="${pageContext.request.contextPath}/public/qiantai/shoppingcar.jsp" target="_self">我的购物车</a></li>
        ...
        <div id='pdv_3608' class='pdv_class'  title='' style='width:208px; height:100px; top:-22px; left:0px; z-index:9'>
          <div id='spdv_3608' class='pdv_top' style='overflow:hidden;width:100%;height:100%'>
            <div class="pdv_border" style="margin:0;padding:0;height:100%;border:0px  solid;background:;">
              ...
              <div style="padding:0px"> 
              <img src="${pageContext.request.contextPath}/public/qiantai/images/yaoyaolingxian.jpg" alt="" width="100%" border="0"  />
              </div>
