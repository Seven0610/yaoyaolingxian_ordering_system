...
<table width="900" border="0" align="center" cellpadding="0" cellspacing="0">
  ...
  <tr>
	...
	%>
		...
		<tr>
			<td  class="line_table" height="25" align="right" width="20%"><span class="left_bt2">商品名称：</span></td>
		...
		<tr>
			<td  class="line_table" height="25"  align="right" width="20%"><span class="left_bt2">商品类别：</span></td>
			<td  class="line_table"  height="25"  width="80%">
