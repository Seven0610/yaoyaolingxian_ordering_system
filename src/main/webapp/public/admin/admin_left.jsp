	...
	<tr>
		<td width="182" valign="top"><div id="container">
			...
			<div class="content">
				...
				<ul class="MM">
					<li><a href="<c:url value="/menus/toAddPage"/>" target="main">添加新商品</a></li>
					<li><a href="<c:url value="/menus/allMenus"/>" target="main">商品信息列表</a></li>
				</ul>
			</div>
			<h1 class="type">
				<a href="javascript:void(0)">商品类别管理</a>
			</h1>
			<div class="content">
				<table width="100%" border="0" cellspacing="0" cellpadding="0">
					<tr>
